# AI Model Distillation for Financial Data Documentation

Navigation guide to find the right documentation for your role and task.
...
→ [Production Deployment](10-production-deployment.md) or [Helm Installation](11-helm-installation.md)

**📊 Understand evaluation results**  
→ [Evaluation Types and Metrics](06-evaluation-types-and-metrics.md)

**🔌 Integrate my application**  
→ [Data Logging for AI Apps](data-logging.md)

**🚨 Troubleshoot issues**  
→ [Limitations & Best Practices](05-limitations-best-practices.md)

---

<details>
<summary>👥 Documentation by Role</summary>
...
<details>
<summary>🗺️ Common Reading Paths</summary>
...
<details>
<summary>🔗 How Documents Connect</summary>

```mermaid
graph TD
    A[README Start] --> B[Audience Guide]
    A --> C[Quickstart]
    B --> D[Configuration]
    C --> D
    D --> E[Data Logging]
